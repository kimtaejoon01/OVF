...
class LoRA_ViT_base(nn.Module):
    def __init__(self, vit_model, rank: int, lora_layer=None):
        super(LoRA_ViT_base, self).__init__()
...
class LoRA_ViT_timm(LoRA_ViT_base):
    def __init__(self, vit_model: timm_ViT, rank: int, lora_layer=None):
        super(LoRA_ViT_timm, self).__init__(vit_model=vit_model, rank=rank)
